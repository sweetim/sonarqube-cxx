...
RUN curl -O https://github.com/SonarOpenCommunity/sonar-cxx/releases/download/cxx-0.9.8/sonar-cxx-plugin-0.9.8.jar
RUN curl -O https://github.com/mibexsoftware/sonar-bitbucket-plugin/releases/download/v1.2.1/sonar-bitbucket-plugin-1.2.1.jar
